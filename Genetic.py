...
from module.Game import Controller
import random
import numpy as np
...
class GeneticAlgorithm:
    ...
    def tournament(self, net1, net2, net3):
        ...
        """
        game = Controller()
        game.start(network = net1)  # net1 plays a game and so on..
        score1 = game.score
        game.start(network = net2)
        score2 = game.score
        game.start(network = net3)
        score3 = game.score
    ...
    def crossover(self, net1, net2):
        ...
        game = Controller()
        game.start(network=res1)  # child 1 plays a game
        score1 = game.score
        game.start(network=res2)  # child 2 plays a game
        score2 = game.score
